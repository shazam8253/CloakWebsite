            ...
            <div className="hero" id='hero'>
                ...
                <div className="flex flex-col lg:flex-row mt-32 py-8 justify-center text-center lg:text-center">
                    <div className="lg:w-1/8 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                        <div className="text-7xl font-bold tracking-tight text-white mt-1"> Pioneering discreet trading on chain.</div>
                        <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                            <Link to="/contact" className="text-white bg-md-slate-blue hover:bg-blue-800 inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-2xl sm:w-auto sm:mb-0">
                                Learn more
