...
import cloakLogo from "../../images/cloak-logo.svg";
        ...
        <nav className={`fixed font-[Inter] top-0 w-full z-30 transition duration-300 ease-in-out mb-16 ${!top && 'bg-white'}`}>
            <div className="flex flex-row justify-between items-center py-2">
                ...
                <div className="group flex flex-col items-center">
                    <button className="p-2 rounded-lg lg:hidden text-md-slate-blue" onClick={handleClick}>
                    ...
                    <div className='hidden space-x-4 lg:inline-block p-5'>
                        <NavLinks />
                    </div>
